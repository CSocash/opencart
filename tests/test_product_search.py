...
2. Locate th searchbox on the Home page.
3. Enter a valid product name (for example, "iPhone") in the search box.
4. Click on the "Search" button.
5. Verify that the Search Results page is displayed.
6. Check if the searched product name appears int eh list of search results.

Expected Result:
--------------------
This Search Results page shoudl appear, and the searched product should be visible in the search results list.
